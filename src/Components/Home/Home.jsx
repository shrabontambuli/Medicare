    ...
    <div className="mt-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-center px-5 lg:px-0 mt-24 lg:mt-32">
        <div>
          ...
          <img
            className="mt-4"
            src="/icons/output-onlinepngtools (1) 2.png"
            alt=""
          />
          <p className="mt-2">
        ...
        <div>
          ...
          <img
            className="lg:py-20"
            src="/icons/output-onlinepngtools 2.png"
            alt=""
          />
          <p className="text-xl lg:ms-16">
            <span className="text-[#1CB5BD] text-3xl">“</span> A trusted
            assistance companion for your <br /> health needs.{" "}
            <span className="text-[#1CB5BD] text-3xl">”</span>
          </p>
        </div>
      </div>
      ...
      <div className="bg-[#1CB5BD] grid grid-cols-1 lg:grid-cols-3 gap-4 items-center justify-items-center py-16 px-10 rounded-lg mt-10 lg:mt-0">
        <div className="flex items-center justify-between">
          ...
          <div className="ms-5">
            ...
            <p className="text-[#E9F7F8] mt-2">
              Collaboratively administrate turnkey <br /> channels whereas
              virtual e-tailers.{" "}
            </p>
          </div>
        </div>
        <div className="flex items-center justify-between ">
          <div>
            <div className="bg-[#E9F7F8] w-[75px] h-[120px] rounded-lg">
              <img
                ...
                src="/icons/bi_clipboard2-plus.png"
                alt=""
              />
            </div>
          </div>
          <div className="ms-5">
            ...
            <p className="text-[#E9F7F8] mt-2">
              Capitalize on low hanging fruit to identify a <br /> ballpark
        ...
        <div className="flex items-center justify-between ">
          <div>
            <div className="bg-[#E9F7F8] w-[75px] h-[120px] rounded-lg">
              <img
                className="mx-auto pt-12"
                src="/icons/iconoir_healthcare.png"
                alt=""
              />
            </div>
          </div>
      ...
      <div className="mt-14 lg:mt-28 px-5 lg:px-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 items-center justify-items-stretch">
          <div>
            <h2 className="text-4xl font-semibold">
              Your health requirements are <br /> our first focus.
            </h2>
          </div>
          <div>
            <p className=" text-2xl text-[#787878] ms-24">
              {" "}
        ...
        <div className="mt-20 grid grid-cols-1 lg:grid-cols-4 gap-4 items-center justify-items-center">
          <div className="bg-[#FEEFEB] p-16 w-80 h-72">
            ...
            <h3 className="mt-3 font-semibold text-xl text-center">
              Customer Support
            </h3>
          </div>
      ...
      <div className="bg-[#1CB5BD] mt-24 px-5 lg:px-28 py-20">
        <div>
          <h2 className="text-[#E9F7F8] text-4xl font-normal">
            Our Department
          </h2>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 mt-16">
          <div className="border border-[#E9F7F8] rounded-sm p-5 h-96">
            <div className="flex items-center">
              ...
              <h2 className="text-[#E9F7F8] text-xl font-medium ms-4">
                Neurology
              </h2>
            </div>
            <div className="mt-6">
              <p className="text-[#cae8ec]">
            ...
            <div className="mt-4">
              <button className="text-[#E9F7F8] text-sm pb-10">
                READ MORE
              </button>
            </div>
          </div>
            ...
            <div className="border border-[#E9F7F8] rounded-sm p-5 h-96">
              ...
              <div className="mt-6">
                <p className="text-[#cae8ec]">
                  ...
                  cardiovascular system. The field includes medical diagnosis
                  and treatment of congenital heart...........
                </p>
              </div>
              <div className="mt-4">
                <button className="text-[#E9F7F8] text-sm pb-10">
          ...
          <div>
            <div className="border border-[#E9F7F8] rounded-sm p-5 h-96">
              <div className="flex items-center">
                <img
                  className="w-16"
                  src="/icons/surgical_sterilization.png"
                  alt=""
                />
                <h2 className="text-[#E9F7F8] text-xl font-medium ms-4">
                  Surgery
              ...
              <div className="mt-6">
                <p className="text-[#cae8ec]">
                  Surgery is a medical specialty that uses manual and/or
                  instrumental techniques to physically reach into a subjects
                  body in order to investigate or treat pathological conditions
                  such as a disease...........
                </p>
              </div>
              <div className="mt-4">
            ...
            <div className="border border-[#E9F7F8] rounded-sm p-5 h-96">
              ...
              <div className="mt-6">
                <p className="text-[#cae8ec]">
                  ...
                  system is a complex, sophisticated system that regulates and
                  coordinates body..........
                </p>
              </div>
              <div className="mt-4">
            ...
            <div className="border border-[#E9F7F8] rounded-sm p-5 h-96">
              ...
              <div className="mt-6">
                <p className="text-[#cae8ec]">
                  ...
                  similar to that of a medical doctor. The first step is to
                  complete an undergraduate program in a related field like
                  biology, chemistry, health, or math, and earn a...........
                </p>
              </div>
              <div className="mt-4">
                <button className="text-[#E9F7F8] text-sm pb-10">
          ...
          <div>
            <div className="border border-[#E9F7F8] rounded-sm p-5 h-96">
              ...
              <div className="mt-6">
                <p className="text-[#cae8ec]">
                  Ophthalmology, medical specialty dealing with the diagnosis
                  and treatment of diseases and disorders of the eye. The first
                  ophthalmologists were oculists. These paramedical specialists
                  practice.........
                </p>
              </div>
              <div className="mt-4">
          ...
          <div>
            <div className="border border-[#E9F7F8] rounded-sm p-5 h-96">
              <div className="flex items-center">
                <img
                  className="w-16"
                  src="/icons/pediatric_surgery.png"
                  alt=""
                />
                <h2 className="text-[#E9F7F8] text-xl font-medium ms-4">
                  Pediatry
              ...
              <div className="mt-6">
                <p className="text-[#cae8ec]">
                  Pediatrics (also spelled paediatrics or pædiatrics) is the
                  branch of medicine that involves the medical care of infants,
                  children, adolescents, and young adults. In the United
                  Kingdom, paediatrics covers many of...........
                </p>
              </div>
              <div className="mt-4">
                <button className="text-[#E9F7F8] text-sm pb-10">
      ...
      <div className="mt-24 bg-[#E9F7F8] pt-16 pb-6 px-4 lg:px-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          <div className="relative">
            ...
            <img
              className="absolute right-14 lg:bottom-14"
          ...
          <div className="mt-72 lg:mt-10">
            ...
            <div className="flex items-center mt-28">
              <div>
                <img
                  className="bg-[#FFF] rounded-full p-2 lg:p-5"
                  src="/icons/rural_post.png"
                  alt=""
                />
              </div>
              <div className="ms-6">
                ...
                <p className="text-sm">
                  Modern Clinic Design: Strategies for an Era of Change is a
                  comprehensive <br /> guide to optimizing patient experience
            ...
            <div className="flex items-center mt-20">
              ...
              <div className="ms-6">
                ...
                <p className="text-sm">
                  WE are used to believe that doctors are not greedy traders.
                  Those who have an ambition <br /> to earn huge money should
                  not come to the medical profession.{" "}
                </p>
              </div>
            </div>
            <div className="flex items-center mt-20">
              ...
              <div className="ms-6">
                ...
                <p className="text-sm">
                  Professional medical treatment means being seen for evaluation
                  or treatment by a health <br /> care professional such a
                  physician, physician assistant, dentist, nurse, etc.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#E9F7F8] p-9 w-80 h-72 bor">
            ...
            <div className="rating mt-5">
              <input
                type="radio"
                name="rating-1"
                className="mask mask-star bg-[#1CB5BD]"
              />
              <input
                type="radio"
                name="rating-1"
            ...
            <div className="relative ms-10">
              ...
              <div>
                <img
                  className="w-32 absolute -right-6 -top-10"
        ...
        <div className="mt-32 bg1 w-10/12 mx-auto rounded-3xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 justify-items-center items-center gap-4 py-10">
            <div className="px-6 lg:px-0">
              <h3 className="text-[#FFF] font-medium text-3xl">
            ...
            <div>
              <p className="bg-[#FFF] text-[#1CB5BD] font-medium py-4 px-10 bor2">
        ...
        <div className="md:flex justify-center md:justify-between text-center md:text-start">
          <div>
            <h2 className="text-xl lg:text-3xl">
              What you need to know about healthy <br /> living
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 justify-items-center items-center gap-5 mt-20">
          <div className="w-full">
            <img
              ...
              src="/images/Rectangle 53.jpg"
              alt=""
            />
            <p className="mt-6 text-[#1CB5BD] font-medium">APRIL 26, 2022</p>
            <h4 className="mt-6 text-xl font-semibold">
              Updated Covid boosters rolled out a month ago. Here is how <br />{" "}
              many Americans have gotten them.
            </h4>
            <p className="mt-4 text-[#5E5E5E]">
              The CDC recommends that everyone over 12 get an updated booster as{" "}
              <br /> long as at least two months have passed since their last
              Covid shot.
            </p>
          ...
          <div>
            ...
            <div className="flex mt-14">
              <div>
                <img
                  className="w-80"
                  src="/images/Rectangle 53 (1).jpg"
                  alt=""
                />
              </div>
              <div className="ms-6">
                <h3 className="text-xl text-[#1CB5BD] font-medium">
            ...
            <div className="flex mt-10">
              ...
              <div className="ms-6">
                <h3 className="text-xl text-[#1CB5BD] font-medium">
                  Monkeypox Case Rates 5 Times Higher Among Black Americans
                </h3>
                <p className="mt-3">
                  events, exhibitions, publications, and initiatives hosted by,
                  led by, or featuring members of the School of Art communityt
                </p>
              </div>
            </div>
            <div className="flex mt-10">
              <div>
                <img
                  className="w-80"
                  src="/images/Rectangle 53 (2).jpg"
                  alt=""
                />
              </div>
              <div className="ms-6">
                <h3 className="text-xl text-[#1CB5BD] font-medium">
                  The Happy Hormone: Why We Should not Mess With Dopamine
                </h3>
                <p className="mt-3">
                  Mailchimp emails and announcements sent out by the Yale School
                  of Art’s Communications Office
                </p>
              </div>
            </div>
          </div>
